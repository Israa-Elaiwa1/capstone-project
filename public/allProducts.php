            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme">
                  ...
                  <div class="item"> <a href="#"><img alt="" src="../images/slide-07.jpg" height="400" width ="1000"></a>
              ...
              <div id="sort-by">
                ...
                <ul>
                  <li><a href="#">Alphabatical<span class="right-arrow"></span></a>
                    <ul><?php
                echo"
                      <li><a href='allProducts.php?action=price'>price</a></li>
                      <li><a href='allProducts.php?action=new'>Newest</a></li>";
                      ?>
                    </ul>
                  </li>
                </ul>
